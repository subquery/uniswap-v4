...
// Pre-computed hex values for tick calculations
const TICK_HEX_VALUES: { [key: number]: string } = {
...
export function getSqrtRatioAtTick(tick: number): bigint {
  ...
  const pow2_32 = BigInt(2) ** BigInt(32)
  return ratio / pow2_32 + (ratio % pow2_32 > BigInt(0) ? BigInt(1) : BigInt(0))
}
